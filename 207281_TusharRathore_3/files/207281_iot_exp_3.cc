...
//#include "ns3/ble-net-device.h"  // adding the required modules

using namespace ns3;

NS_LOG_COMPONENT_DEFINE("207281_tushar_iot_exp3");
...
int main (int argc, char **argv)
{
  ...
  NS_LOG_INFO("Installing BLE");
  CsmaHelper ble;
  NetDeviceContainer ble_temp = ble.Install(nodes);
  ...
  csma.EnableAsciiAll(ascii.CreateFileStream("experiments/E3/ble_udp.tr"));
  csma.EnablePcapAll(std::string("experiments/E3/ble_ping6"),true);
